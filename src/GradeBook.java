...
public class GradeBook {
    ...
    //output bar chart displaying grade distribution0
    private void outputBarChart() {
        ...
        //for each grade freqency, print bar in chart
    ...
    public int getMaximum() {
        //assume that grades[0] is the highest
    ...
    public int getMinimum() {
        //assume that grades[0] is the lowest
